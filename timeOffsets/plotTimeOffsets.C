...
void plotTimeOffsets()
{
  ...
  TH1D* timeH1 = new TH1D("timeH1",";time [ns];entries",7000,0,7);
  TH1D* timeH2 = new TH1D("timeH2",";time [ns];entries",7000,0,7);
  TH1D* timeH3 = new TH1D("timeH3",";time [ns];entries",7000,0,7);
  TH1D* timeH4 = new TH1D("timeH4",";time [ns];entries",7000,0,7);
